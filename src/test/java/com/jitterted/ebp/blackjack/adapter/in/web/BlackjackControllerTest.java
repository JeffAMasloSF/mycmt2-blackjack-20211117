...
class BlackjackControllerTest {
    ...
    @Test
    public void hitCommandResultsInThirdCardDealtToPlayerAndNotDone() throws Exception {
    ...
    @Test
    public void playerDealtBlackjackRedirectToDonePageAndPlayerIsDone() throws Exception {
